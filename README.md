...
This is basic TODO App created using React JS. In this application we can add the TODO list item, view it, edit it, mark it as completed and delete it. This app shows the realtime use of concepts like useState, useEffect, Context API, Local Storage, Event Handling.
